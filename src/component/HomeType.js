...
import "../Template/css/ScrollToTopButton.css"
...
export function HomeType(props) {
    ...
    useEffect(() => {
        let fetchData = async () => {
            ...
            setRssHome(rssItems);
            //lay ra tieu de trang
            let channelTitle = xml.querySelectorAll("channel");
            let channelItems ;
            channelTitle.forEach((item) => {
                channelItems = item.querySelector("title").textContent;

            });
            setRssChannel(channelItems);
    ...
    return (
        <div>
            ...
            <div className="container p-t-4 p-b-40">
                <h2 className="f1-l-1 cl2">{rssChannel}</h2>
            </div>
            {/* Feature post */}
                    ...
                    <div className="row justify-content-center">
                        <div className="col-md-10 col-lg-8 p-b-80">
                            ...
                            <div className="row">
                                {rssHome.length > 0 &&
                                    <>
                                        {rssHome.slice(5).map((item, index) => (
                                            <>
                            ...
                            <div className="p-l-10 p-rl-0-sr991">
                                ...
                                <div className="flex-c-s p-b-50">
                                    <a href="#">
                                        <img
                                            ...
                                            src="https://truongquochoc.com/wp-content/uploads/2020/10/25-hinh-nen-bong-da-dep-nhat-the-gioi-full-hd-16.jpg"
                                            alt="IMG"
                                        />
                                    </a>
                                ...
                                <div className="flex-c-s p-b-50">
                                    <a href="#">
                                        <img
                                            className="max-w-full"
                                            src="https://img.meta.com.vn/Data/image/2021/06/14/hinh-nen-bong-da-12.jpg"
                                            alt="IMG"
                                        />
                                    </a>
