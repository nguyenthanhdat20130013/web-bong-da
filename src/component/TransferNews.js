...
export function TransferNews(props){
    const [rssTransferNews, setRssTransferNews] = useState([]);
    ...
    return(
        <div>
            ...
            <div className="container">
                <div className="bg0 flex-wr-sb-c p-rl-20 p-tb-8">
                    <div className="f2-s-1 p-r-30 m-tb-6">
                        <a href="trang-chu" className="breadcrumb-item f1-s-3 cl9">
                            Trang chủ
                        </a>
                        <a href="trang-chu/tin-chuyen-nhuong" className="breadcrumb-item f1-s-3 cl9">
                            Tin chuyển nhượng
                        </a>
                    </div>
            ...
            <div className="container p-t-4 p-b-40">
                <h2 className="f1-l-1 cl2">Tin chuyển nhượng</h2>
            </div>
            {/* Feature post */}
                ...
                <div className="container">
                    <div className="row m-rl--1">
                        <div className="col-md-6 p-rl-1 p-b-2">
                            {rssTransferNews.length > 0 &&
                                <>
                                    <div className="bg-img1 size-a-3 how1 pos-relative" style={{ backgroundImage:  `url(${rssTransferNews[0].image})` }}>
                                        <a
                                        ...
                                        <div className="flex-col-e-s s-full p-rl-25 p-tb-20">
                                            <a style={{ zIndex: '3',fontSize : '23px' }}
                                               href="blog-detail-01.html" className="how-txt1 size-a-6 f1-l-1 cl0 hov-cl10 trans-03">
                                                {rssTransferNews[0].title}
                                            </a>


                                            <span className="how1-child2">
                        <span className="f1-s-4 cl11">{rssTransferNews[0].pubDate}</span>
                <a style={{ opacity : '0.98'}}
                   href="blog-detail-01.html" className="how-txt1 size-h-1 f1-m-1 cl0 hov-cl10 trans-03">
                    {rssTransferNews[0].description}
                </a>
                        ...
                        <div className="col-md-6 p-rl-1">
                            <div className="row m-rl--1">
                                {rssTransferNews.length > 0 &&
                                    <>
                                        {rssTransferNews.slice(1, 5).map((item, index) => (
